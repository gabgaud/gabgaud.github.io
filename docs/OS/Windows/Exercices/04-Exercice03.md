...
Sélectionnez une application gratuite <mark>**dont le développeur n'est pas Microsoft**</mark> (par exemple, une application de productivité ou un petit jeu simple) et tentez de procéder à son installation.
...
Bien qu'il n'y ait pas beaucoup d'éléments à vérifier dans le cadre de cet exercice, je vous offre tout de même la possibilité de vous corriger. Exécutez simplement ce [script de correction](../Assets/Exercices/03/)